...
class CdAdmin extends Migrator
{
    /**
     * Change Method.
     *
    ...
    public function change()
    {
        ...
        $table->addColumn('nickname', 'string', array('null'=>'null','limit' => 24))
            ->addColumn('username', 'string', array('limit' => 24))
            ->addColumn('password', 'string', array('limit' => 100))
            ->addColumn('email', 'string', array('limit' => 100))
            ->addColumn('avatar', 'string', array('null' => 'null', 'limit' => 255))
